...
const MODELS = [
  { id: 'gemini-3.1-flash-lite', name: 'gemini-3.1-flash-lite', desc: '빠르고 경량화된 답변 (Google)' },
  { id: 'gemini-3.5-flash', name: 'gemini-3.5-flash', desc: '균형 잡힌 성능 및 멀티모달 (Google)' },
  { id: 'gemini-3-flash-preview', name: 'gemini-3-flash-preview', desc: '최신 파서 및 지능 미리보기 (Google)' },
  { id: 'gpt-4o-mini', name: 'gpt-4o-mini', desc: '고성능 경량 AI 모델 (OpenAI)' },
